const _promptCorrida = 'Transcrição fiel em português brasileiro. Contexto: serviço de corridas e transporte urbano em qualquer cidade do Brasil. LOGRADOUROS: Rua, Avenida, Av, Travessa, Trav, Alameda, Al, Estrada, Rodovia, Rod, Beco, Viela, Praça, Pç, Largo, Vila, Quadra, QD, Setor, Conjunto, Conj, Loteamento, Lot, Sítio. PONTOS DE REFERÊNCIA COMUNS: hospital, UPA, pronto-socorro, clínica, farmácia, drogaria, mercado, supermercado, hipermercado, atacado, padaria, açougue, posto de gasolina, posto, escola, colégio, faculdade, universidade, banco, lotérica, correios, cartório, fórum, prefeitura, câmara, delegacia, polícia, bombeiros, rodoviária, terminal, aeroporto, porto, estação, shopping, mall, feira, praça, parque, estádio, ginásio, arena, igreja, catedral, santuário, templo, cemitério, condomínio, residencial, conjunto habitacional, COHAB, CDHU, vila, bairro, distrito, zona, setor. GÍRIAS E EXPRESSÕES REGIONAIS BRASILEIRAS — Norte/Nordeste: "égua", "oxe", "visse", "aff", "meu rei", "meu rei não", "meu fi", "véi" — Sudeste/MG: "uai", "trem", "sô", "mô", "minuano", "rapaiz" — Sul: "bah", "tchê", "tri", "guri", "guria", "piá", "pia" — Centro-Oeste: "mano", "cara", "brother". EXPRESSÕES DE LOCALIZAÇÃO: "tô aqui ó", "manda aqui", "tô lá no", "me busca aqui", "pode vir", "tô na frente do", "aqui ó", "lá no fundo", "pertinho do", "ali do lado", "bem aqui", "esse aqui mesmo", "aqui no meu serviço", "tô no trampo", "no trabalho", "aqui em casa", "saindo agora", "já tô na rua", "chega logo", "corre que tô atrasado", "tô com pressa", "pode mandar", "manda logo", "vai pro de sempre", "mesmo lugar de antes", "lugar de sempre", "mesmo endereço", "aqui pertinho", "bem na esquina", "do lado do", "em frente ao", "atrás do", "dentro do", "na entrada do", "no estacionamento do", "no portão", "no portão de entrada", "na recepção", "no saguão". NÚMEROS FALADOS: "mil e duzentos"=1200, "duzentos e cinquenta"=250, "vinte e três"=23, "cento e vinte"=120 — converta números por extenso para algarismos quando for parte de endereço. FALA COLADA COMUM: se duas palavras parecerem unidas sem sentido, tente separá-las como logradouro + nome. REGRAS: (1) Transcreva EXATAMENTE o que foi dito — nunca substitua por palavra parecida. (2) Siglas e códigos devem ser transcritos letra por letra. (3) Nomes de ruas, bairros e pontos de referência: transcreva o som exato, não interprete. (4) Se não entendeu uma palavra, deixe como está — não invente. (5) Áudio com ruído de carro, vento, TV ou criança ao fundo: foque nas palavras mais claras e ignore o fundo. (6) Áudio muito curto com só 1 ou 2 palavras: transcreva exatamente, sem completar ou inferir.');
...
formData.append('prompt', _isDelivery ? _promptDelivery : _promptCorrida);const axios = require('axios');
    ...
    async transcreverAudio(buffer, mimeType = 'audio/ogg', contextoConversa = null) {
        ...
        const chamarWhisper = async (buf, mime, forceLang) => {
            try {
                ...
                // Prompt adaptado por contexto
const _isDelivery = contextoConversa && contextoConversa.tipo === 'delivery';
const _promptDelivery = 'Transcrição fiel em português brasileiro. Contexto: serviço de delivery e pedidos de comida. ALIMENTOS: arroz, feijão, frango, carne, peixe, salada, macarrão, sopa, marmita, prato feito, PF, executivo, self-service, sobremesa, suco, refrigerante, água, cerveja. PERSONALIZAÇÕES COMUNS: sem cebola, sem alho, sem pimenta, mais arroz, menos sal, bem passado, mal passado, ao ponto, sem molho, com molho, à parte, caprichado, reforçado, cheio, bem servido, sem mistura, só proteína. QUANTIDADES: meia, um, dois, três, uma porção, meia porção, por favor, obrigado. ENDEREÇOS para entrega: rua, avenida, número, bairro, apartamento, bloco, casa. REGRAS: (1) Transcreva exatamente o que foi dito. (2) Nomes de pratos: transcreva o som exato. (3) Se não entendeu, deixe como está.';
const _promptCorrida = 'Transcrição fiel em português brasileiro. Contexto: serviço de corridas e transporte urbano em qualquer cidade do Brasil. LOGRADOUROS: Rua, Avenida, Av, Travessa, Trav, Alameda, Al, Estrada, Rodovia, Rod, Beco, Viela, Praça, Pç, Largo, Vila, Quadra, QD, Setor, Conjunto, Conj, Loteamento, Lot, Sítio. PONTOS DE REFERÊNCIA COMUNS: hospital, UPA, pronto-socorro, clínica, farmácia, drogaria, mercado, supermercado, hipermercado, atacado, padaria, açougue, posto de gasolina, posto, escola, colégio, faculdade, universidade, banco, lotérica, correios, cartório, fórum, prefeitura, câmara, delegacia, polícia, bombeiros, rodoviária, terminal, aeroporto, porto, estação, shopping, mall, feira, praça, parque, estádio, ginásio, arena, igreja, catedral, santuário, templo, cemitério, condomínio, residencial, conjunto habitacional, COHAB, CDHU, vila, bairro, distrito, zona, setor. GÍRIAS E EXPRESSÕES REGIONAIS BRASILEIRAS — Norte/Nordeste: "égua", "oxe", "visse", "aff", "meu rei", "meu rei não", "meu fi", "véi" — Sudeste/MG: "uai", "trem", "sô", "mô", "minuano", "rapaiz" — Sul: "bah", "tchê", "tri", "guri", "guria", "piá", "pia" — Centro-Oeste: "mano", "cara", "brother". EXPRESSÕES DE LOCALIZAÇÃO: "tô aqui ó", "manda aqui", "tô lá no", "me busca aqui", "pode vir", "tô na frente do", "aqui ó", "lá no fundo", "pertinho do", "ali do lado", "bem aqui", "esse aqui mesmo", "aqui no meu serviço", "tô no trampo", "no trabalho", "aqui em casa", "saindo agora", "já tô na rua", "chega logo", "corre que tô atrasado", "tô com pressa", "pode mandar", "manda logo", "vai pro de sempre", "mesmo lugar de antes", "lugar de sempre", "mesmo endereço", "aqui pertinho", "bem na esquina", "do lado do", "em frente ao", "atrás do", "dentro do", "na entrada do", "no estacionamento do", "no portão", "no portão de entrada", "na recepção", "no saguão". NÚMEROS FALADOS: "mil e duzentos"=1200, "duzentos e cinquenta"=250, "vinte e três"=23, "cento e vinte"=120 — converta números por extenso para algarismos quando for parte de endereço. FALA COLADA COMUM: se duas palavras parecerem unidas sem sentido, tente separá-las como logradouro + nome. REGRAS: (1) Transcreva EXATAMENTE o que foi dito — nunca substitua por palavra parecida. (2) Siglas e códigos devem ser transcritos letra por letra. (3) Nomes de ruas, bairros e pontos de referência: transcreva o som exato, não interprete. (4) Se não entendeu uma palavra, deixe como está — não invente. (5) Áudio com ruído de carro, vento, TV ou criança ao fundo: foque nas palavras mais claras e ignore o fundo. (6) Áudio muito curto com só 1 ou 2 palavras: transcreva exatamente, sem completar ou inferir.');
                const resp = await axios.post('https://api.openai.com/v1/audio/transcriptions', formData, {
                    headers: { 'Authorization': 'Bearer ' + this.apiKey, ...formData.getHeaders() },
                    timeout: 15000
        ...
        try {
                ...
                if (CerebroRebeca.isAtivo() && contextoConversa) {
                    ...
                    if (_resCerebro) {
                        ...
                        const jsonCerebro = {
                            ...
                            obs_motorista: _de.obs_motorista || _de.observacao || _de.ponto_referencia || null,
                            ponto_referencia: _de.ponto_referencia || null,
                            observacao_origem: _de.observacao_origem || _de.complemento || null,
            ...
            const resp = await axios.post('https://api.openai.com/v1/chat/completions', {
                ...
                messages: [{
                    role: 'system',
                    content: (() => {
                        const _isMoto = !!(contextoConversa && contextoConversa._contextoExtraMoto);
                        const _regrasMoto = _isMoto ? ' (10) tipo_servico_moto: se cliente pediu corrida de moto=CORRIDA, encomenda/entrega=ENCOMENDA, socorro/gasolina=SOCORRO_GASOLINA, buscar terceiro=BUSCAR_TERCEIRO — caso contrario null. (11) produto_encomenda: nome do produto/encomenda mencionado. (12) endereco_coleta: endereco de onde buscar a encomenda. (13) endereco_entrega: endereco de onde entregar a encomenda. (14) valor_gasolina: valor em reais mencionado para gasolina (ex: 20, 30). (15) nome_destinatario: nome de quem vai receber a encomenda. (16) nome_remetente: nome de quem vai enviar. Retorne APENAS JSON: {"origem_extraida":null,"destino_extraido":null,"horario_agendamento":null,"confirmacao":false,"cancelamento":false,"nome_cliente":null,"cor_camisa":null,"resposta_rebeca":"","proxima_etapa":"","notificar_admin":false,"tipo_servico_moto":null,"produto_encomenda":null,"endereco_coleta":null,"endereco_entrega":null,"valor_gasolina":null,"nome_destinatario":null,"nome_remetente":null}' : ' Retorne APENAS JSON: {"origem_extraida":null,"destino_extraido":null,"horario_agendamento":null,"confirmacao":false,"cancelamento":false,"nome_cliente":null,"cor_camisa":null,"resposta_rebeca":"","proxima_etapa":"","notificar_admin":false}';
                        return 'Analise o audio transcrito e extraia APENAS os dados mencionados pelo cliente. Retorne APENAS JSON sem markdown. NAO gere resposta_rebeca — deixe sempre vazio, pois o sistema responde com dados reais do banco. ETAPA ATUAL: "' + etapaAtual + '". DADOS JA COLETADOS: ' + dadosAtuais + '. REGRAS: (1) resposta_rebeca SEMPRE vazio. (2) Extraia origem_extraida se cliente mencionou endereco de partida — ponto de referencia, estabelecimento, rua, bairro = valido. (3) Extraia destino_extraido se cliente mencionou destino. (4) horario_agendamento em ISO 8601 se cliente mencionou data/hora. (5) confirmacao=true se cliente confirmou. (6) cancelamento=true se cliente cancelou. (7) nome_cliente se cliente disse o nome. (8) cor_camisa se cliente mencionou cor da roupa. (9) notificar_admin=true APENAS se reclamou ou pediu atendimento humano.' + _regrasMoto;
                    })()
                }, {
                    role: 'user',
...
- GANCHOS BRASILEIROS — identifique essas falas e reaja naturalmente, sempre em 1-2 frases curtas e objetivas: "oi sumida/cadê você/tá viva" → "Kkk tô aqui sim! 😄 Precisando de carro?"; "que saudade/faz tempo" → "Saudade boa! 😊 Bora?"; "tô mal/tô triste/tô chateado" → "Ai não 😟 Quer uma corridinha pra arejar?"; "eita/nossa/meu Deus" → "Eeita! O que foi? 😅"; "socorro" em tom normal → "Kkk tô aqui! O que houve? 😄"; "na correria/atolado/ocupado" → "Entendido! Me chama quando puder 😊"; "cansado/que dia/que semana" → "Canseira demais 😅 Pelo menos no carro descansa!"; "valeu/obrigado/obg" → "Imagina! 😊" ou "Tamo junto!"; "boa/show/top/massa" → "Boa! 😄"; palavrão em tom animado (fds, pqp) → entra na vibe sem repetir o palavrão; cliente contou história ou desabafou → reage em 1 frase com empatia real + oferece carro se fizer sentido; falou de médico/hospital/passou mal → "Melhoras! 🙏 Precisa de carona?"; falou de festa/balada/evento → "Boa festa! 🎉 Vai precisar de carro pra voltar?"; falou de chuva/calor/tempo ruim → reage ao clima e oferece carro naturalmente. SEMPRE recíproca — ri quando é engraçado, se preocupa quando é sério, anima quando o cliente tá animado.
