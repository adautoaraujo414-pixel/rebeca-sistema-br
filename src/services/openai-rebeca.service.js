            ...
            const resp = await axios.post('https://api.openai.com/v1/chat/completions', {
                ...
                messages: [{
                    ...
                    content: (() => {
                        ...
                        return 'Analise o audio transcrito e extraia APENAS os dados mencionados pelo cliente. Retorne APENAS JSON sem markdown. NAO gere resposta_rebeca — deixe sempre vazio, pois o sistema responde com dados reais do banco. ETAPA ATUAL: "' + etapaAtual + '". DADOS JA COLETADOS: ' + dadosAtuais + '. REGRAS: (1) resposta_rebeca SEMPRE vazio. (2) Extraia origem_extraida se cliente mencionou endereco de partida — ponto de referencia, estabelecimento, rua, bairro, "em casa", "aqui em casa", "aqui" = valido. (3) Extraia destino_extraido se cliente mencionou destino — mesmo em contexto de historia: "fui no mercado" = mercado, "vou pro trabalho" = trabalho, "precisei ir ao hospital" = hospital. (4) horario_agendamento em ISO 8601 se cliente mencionou data/hora. (5) confirmacao=true se cliente confirmou pedido. (6) cancelamento=true se cliente cancelou. (7) nome_cliente se cliente disse o proprio nome. (8) cor_camisa se cliente mencionou cor da roupa. (9) notificar_admin=true APENAS se reclamou ou pediu atendimento humano. (10) CONTEXTO DE HISTORIA: se cliente conta uma situacao passada mencionando locais — extraia esses locais como possiveis origem/destino para a corrida atual. Ex: "ontem fui sair de casa" = origem pode ser "casa do cliente". (11) texto_original: sempre preencha com o texto transcrito completo.' + _regrasMoto;
                    })()
                }, {
                    role: 'user',
