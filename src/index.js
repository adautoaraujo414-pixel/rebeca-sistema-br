...
console.log(RODAR_CRONS ? '✅ Cron reativação de clientes ativo' : '⏸️  Cron reativação de clientes (desativado neste processo - WORKER_ROLE=web)');
...
console.log(RODAR_CRONS ? '✅ Cron agendamentos ativo' : '⏸️  Cron agendamentos (desativado neste processo - WORKER_ROLE=web)');
...
console.log(RODAR_CRONS ? '✅ Cron delivery trial ativo' : '⏸️  Cron delivery trial (desativado neste processo - WORKER_ROLE=web)');
console.log(RODAR_CRONS ? '✅ Cron cardápio do dia ativo (7h)' : '⏸️  Cron cardápio do dia (desativado neste processo - WORKER_ROLE=web)');
